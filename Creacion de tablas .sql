...
CONSTRAINT FK_Producto FOREIGN KEY(idProducto) REFERENCES producto (id_producto),
...
CONSTRAINT FK_Cliente FOREIGN KEY(id_clientes) REFERENCES clientes(id_clientes),
CONSTRAINT FK_Venta FOREIGN KEY(id_ticket) REFERENCES venta(id_ticket)
);
